...
final class Strings {
  ...
  public static function all(): array {
    return [
      ...
      'select_rules'         => __( 'Select commission rules', 'fa-commission-rules' ),
      'review_latest'        => __( 'Review latest saved rule', 'fa-commission-rules' ),
      'draft_kept'           => __( 'The latest saved values are shown. Your unsaved draft is kept; restore it to use your changes after reviewing these values.', 'fa-commission-rules' ),
      'restore_draft'        => __( 'Restore my draft', 'fa-commission-rules' ),
      'deleted_draft'        => __( 'This rule was deleted. Create a new rule from your unsaved draft?', 'fa-commission-rules' ),
      ...
      'preset_year'          => __( 'Next 12 months', 'fa-commission-rules' ),
      'time_help'            => __( 'These dates apply to the rule for all customers. Leave both empty for no end date. For a period starting when each customer is referred, use Fluent Affiliate’s lifetime commission expiry setting.', 'fa-commission-rules' ),
